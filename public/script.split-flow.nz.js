...
async function activateSDK(oneSdkConfig) {
    ...
    const consentForm = oneSdk.component("form", {
        ...
        type: "ocr",
        descriptions: [
            { label: 'We will verify your ID against credit bureau data sources and government data sources.' },
            // { label: 'Have your ID handy for verification.', style: myStyle },
            { label: 'Your data is being collected in accordance with our privacy policy.' },
        ],
        // checkBox: {
        //     style: myStyle
        // },
